...
There are many `catalog indexes <https://docs.plone.org/4/en/develop/plone/searching_and_indexing/indexing.html>`_ to query. Here are some examples::
...
.. seealso::
    ...
    https://docs.plone.org/4/en/develop/plone/searching_and_indexing/query.html
...
Like for many js-libraries there is already a package that doe the plone-integration for us: ``collective.js.datatables``. Like all python-packages you can find it on pypi: https://pypi.org/project/collective.js.datatables
