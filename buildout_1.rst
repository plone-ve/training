...
This uses the python-package `plone.recipe.zope2instance <https://pypi.org/project/plone.recipe.zope2instance>`_ to create and configure the Zope 2 instance which we use to run Plone. All the lines after ``recipe = xyz`` are the configuration of the used recipe.

.. seealso::

    https://pypi.org/search/?q=&o=&c=Framework+%3A%3A+Buildout&c=Framework+%3A%3A+Buildout+%3A%3A+Recipe
...
.. seealso::
    ...
    Buildout-Documentation
        * https://docs.plone.org/4/en/old-reference-manuals/buildout/index.html
        * http://www.buildout.org/en/latest/

    Troubleshooting
        https://docs.plone.org/4/en/manage/troubleshooting/buildout.html
