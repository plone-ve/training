...
.. seealso::
    ...
    https://docs.plone.org/4/en/develop/addons/components/genericsetup.html#id1
...
.. seealso::
    ...
    https://docs.plone.org/4/en/develop/plone/views/layers.html
...
.. note::
    ...
    To run additional custom code on (re-)installing an addon you should use a `setuphandler.py <https://docs.plone.org/4/en/develop/addons/components/genericsetup.html#custom-installer-code-setuphandlers-py>`_.
...
.. seealso::
    ...
    https://docs.plone.org/4/en/develop/plone/searching_and_indexing/indexing.html
...
.. seealso::
  ...
  https://docs.plone.org/4/en/develop/plone/functionality/collections.html#add-new-collection-criteria-new-style-plone-app-collection-installed
